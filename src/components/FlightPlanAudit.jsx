    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6 audit-header">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">航班计划审核</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="stat-card bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-4">
              <span className="text-gray-500 text-sm">待审核计划</span>
          ...
          <div className="stat-card bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-4">
              <span className="text-gray-500 text-sm">今日进出港计划</span>
            ...
            <div className="text-4xl font-bold text-gray-900 mb-2">{statistics.todayPlan}</div>
          ...
          <div className="stat-card bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-4">
              <span className="text-gray-500 text-sm">已通过计划</span>
          ...
          <div className="stat-card bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center justify-between mb-4">
              <span className="text-gray-500 text-sm">已驳回计划</span>
        ...
        <div className="data-table bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          <div className="p-6 border-b border-gray-100 flex justify-between items-center">
            <h2 className="text-lg font-semibold text-gray-900">航班计划列表</h2>
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th scope="col" className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">计划编号</th>
                  <th scope="col" className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">邮轮名称</th>
                  <th scope="col" className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">计划类型</th>
                  ...
                  <th scope="col" className="px-6 py-4 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">计划时间</th>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {tableData.map((item) => (
                  <tr key={item.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{item.planType}</td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{item.planTime}</td>
...
export default FlightPlanAudit
